...
async def play(_, message: Message):
    ...
    if audio:
        ...
        [
            [
                InlineKeyboardButton("📚 Ꭰəsᴛəᴋ Ꮪuᴩ", url=f"https://t.me/{BOT_USERNAME}?start"),
                InlineKeyboardButton("📣 Ꮯhᴀnnᴇl", url=f"https://t.me/{UPDATES_CHANNEL}"),
            ],[
